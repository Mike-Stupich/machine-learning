...
# Exercise found here https://colab.research.google.com/notebooks/mlcc/synthetic_features_and_outliers.ipynb?utm_source=mlcc&utm_campaign=colab-external&utm_medium=referral&utm_content=syntheticfeatures-colab&hl=en
...
# Task 1: Create a synthetic feature by calculating rooms per person
california_housing_dataframe["rooms_per_person"] = california_housing_dataframe["total_rooms"] / \
    california_housing_dataframe["population"]

# Task 3: Clip outliers to improve model
...
# Task 2: Identify outliers by plotting. Use this to clip outliers.
plt.figure(figsize=(15, 6))
plt.subplot(1, 2, 1)
