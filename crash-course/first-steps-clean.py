...
# Exercise 1: Get model RMSE < 180
#           -> Done by adjusting learning rate, steps and batch size

# Exercise 2: Replace total_rooms feature with population
#           -> Done by passing in "population" as input_feature parameter,
