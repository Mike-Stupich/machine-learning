...
# Learn to create a minimal set of features that performs as well as a more complex set
...
# Task 2: my solution, RSME of 112
# california_housing_dataframe["latitude"] = california_housing_dataframe["latitude"].apply(
#     lambda x: round(x))
...
#
# Found median_income and rooms_per_person gave very good results.
# Task 2 asks to use feature engineering to make latitude into a good feature
minimal_features = [
    "median_income",
    "latitude"
    # "rooms_per_person"
...
#
# Solution: This is the suggested way to bucketize, rather than rounding as I did
