# Exercise found here:
# https://colab.research.google.com/notebooks/mlcc/validation.ipynb?utm_source=mlcc&utm_campaign=colab-external&utm_medium=referral&utm_content=validation-colab&hl=en#scrollTo=WNX0VyBpHpCX
# Learning to use validation data to prevent overfitting data
...
# Train the model with training data and test against validation data
...
# Compare the results with test data to see if results are consistent, i.e. not overfitted
...
print("Final RMSE (on test data): %0.2f" % rsme)
...
# Plotting median_house_value vs latitude and longitude
